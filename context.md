...
| **Visual Sales Dashboard** | [`leads_dashboard.html`](file:///Users/faiali/Library/CloudStorage/OneDrive-PublicisGroupe/Desktop/ProjectsForPS/TenderBridge/leads_dashboard.html) | Interactive UI with clickable stat-filters, trade intelligence boxes, **Company `ⓘ` Visual Analytics Modals (Pixel-perfect aligned KPI cards with auto text scaling, single-level supply timelines, Export Genius port bar charts, AI Buyer Scoring)**, and distinct **HS Code Customs Manifest Modals**. |
